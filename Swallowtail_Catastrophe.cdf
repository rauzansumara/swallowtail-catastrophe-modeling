...
NotebookDataLength[     15096,        389]
NotebookOptionsPosition[     14479,        366]
NotebookOutlinePosition[     14914,        382]
CellTagsIndexPosition[     14871,        379]
WindowFrame->Normal*)
...
Cell[TextData[Cell[BoxData[
 RowBox[{
  ...
  RowBox[{
   ...
   SuperscriptBox["ax", "3"], "+", 
   SuperscriptBox["bx", "2"], "+", 
   "cx"}]}]],ExpressionUUID->"78e5651c-931d-4937-a3aa-b88dd8931bfa"]], "Text",
 CellChangeTimes->{
  3.8517498605115285`*^9, {3.8517499827790318`*^9, 3.8517499836210885`*^9}, {
   3.8517704663958282`*^9, 
   3.8517704663958282`*^9}},ExpressionUUID->"96a4d7b5-4ae6-43f9-a017-\
4979eb2a9007"],
...
Cell[BoxData[{
   ...
   RowBox[{"(", 
    RowBox[{
     RowBox[{"a", "*", 
      SuperscriptBox["b", "2"]}], "+", 
     RowBox[{"3", 
      SuperscriptBox["b", "4"]}]}], ")"}]}]}], "\[IndentingNewLine]", 
 RowBox[{"y", "=", 
  RowBox[{"c", 
   RowBox[{"(", 
    RowBox[{
 ...
 CellChangeTimes->{
  3.851749888358857*^9, {3.851749944955442*^9, 3.8517499513017645`*^9}, {
   ...
   3.8517633913226714`*^9, {3.8517634845788765`*^9, 
   3.851763710123531*^9}},ExpressionUUID->"631444f0-7ee3-45cc-8389-\
2c752aa2b6ba"],
...
1:eJxTTMoPSmViYGAQA2IQ/Zlv+tYVm9443npQsB1Ec+w12Auipyn4HQDRPSHL
...
iAYAgWLNbw==
  "],
 CellLabel->"In[62]:=",ExpressionUUID->"2f8833e1-94e3-44c4-afc0-42ba72087b22"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = -2., $CellContext`c$$ = 1., 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`a$$], -2, 2}, {
      Hold[$CellContext`c$$], 1, 2}}, Typeset`size$$ = {
    360., {198., 202.98593749999998`}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = True}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = -2, $CellContext`c$$ = 1}, 
      "ControllerVariables" :> {}, 
      "OtherVariables" :> {
      ...
      ParametricPlot[{$CellContext`c$$ (((-2) $CellContext`a$$) \
$CellContext`b - 
          4 $CellContext`b^3), $CellContext`c$$ ($CellContext`a$$ \
$CellContext`b^2 + 3 $CellContext`b^4)}, {$CellContext`b, -10, 10}, 
        PlotRange -> {{-5, 5}, {-1, 10}}], 
      "Specifications" :> {{$CellContext`a$$, -2, 2, Appearance -> 
         "Labeled"}, {$CellContext`c$$, 1, 2, Appearance -> "Labeled"}}, 
      "Options" :> {ControlPlacement -> {Top, Top}}, "DefaultOptions" :> {}],
     ImageSizeCache->{409., {253.13403328722342`, 258.8659667127766}},
 ...
 CellChangeTimes->{
  3.8517657313886366`*^9, {3.8517658755784264`*^9, 3.851765883590869*^9}, {
   ...
   3.8517697271782985`*^9, 3.851769747534594*^9}},
 CellLabel->"Out[62]=",ExpressionUUID->"38e5dcbe-2a00-4eeb-906d-1d13eae02a63"]
}, Open  ]]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.8517465158280497`*^9, 3.8517465158290663`*^9}, 
   ...
   3.851769579524209*^9, 3.8517696038321247`*^9}},
 CellLabel->"In[58]:=",ExpressionUUID->"c721ea72-cf81-4e1c-a18c-00b0c7b83469"],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`c$$ = 1., Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`c$$], 1, 2}}, Typeset`size$$ = {
    360., {129., 133.5575074498184}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = True}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`c$$ = 1}, 
      ...
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      ParametricPlot3D[{$CellContext`c$$ (((-2) $CellContext`a) \
$CellContext`b - 
          4 $CellContext`b^3), $CellContext`c$$ ($CellContext`a \
$CellContext`b^2 + 
          3 $CellContext`b^4), $CellContext`c$$ $CellContext`a}, \
{$CellContext`b, -0.8, 0.8}, {$CellContext`a, -2, 2}, Mesh -> All, PlotRange -> 
        All], "Specifications" :> {{$CellContext`c$$, 1, 2, Appearance -> 
         "Labeled"}}, "Options" :> {ControlPlacement -> {Top, Top}}, 
      "DefaultOptions" :> {}],
     ImageSizeCache->{409., {173.13403328722342`, 178.86596671277658`}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    SynchronousInitialization->True,
 ...
 CellLabel->"Out[58]=",ExpressionUUID->"906c8d38-cd71-4ce1-b336-902d042a95c1"]
}, Open  ]]
}, Open  ]]
}, Open  ]]
},
WindowSize->{664.1999999999999, 510.},
WindowMargins->{{48.599999999999994`, Automatic}, {Automatic, 19.8}},
...
Notebook[{
Cell[CellGroupData[{
Cell[1510, 35, 600, 9, 69, "Chapter",ExpressionUUID->"5873cbab-c996-40db-b99b-813c1ad30d88"],
Cell[2113, 46, 2001, 55, 77, "Text",ExpressionUUID->"a552a7bf-bb4b-40ef-9cf7-23da834b2fc4"],
Cell[4117, 103, 523, 14, 32, "Text",ExpressionUUID->"96a4d7b5-4ae6-43f9-a017-4979eb2a9007"],
Cell[4643, 119, 143, 3, 35, "Text",ExpressionUUID->"72b38a3a-0ace-4621-bb65-2f761ad57b31"],
Cell[4789, 124, 828, 24, 73, "DisplayFormula",ExpressionUUID->"631444f0-7ee3-45cc-8389-2c752aa2b6ba"],
Cell[CellGroupData[{
Cell[5642, 152, 157, 3, 67, "Section",ExpressionUUID->"768c53c4-638d-4611-9460-2537c17f9c51"],
Cell[CellGroupData[{
Cell[5824, 159, 1959, 53, 19, "Input",ExpressionUUID->"2f8833e1-94e3-44c4-afc0-42ba72087b22",
 CellOpen->False],
Cell[7786, 214, 2588, 48, 531, "Output",ExpressionUUID->"38e5dcbe-2a00-4eeb-906d-1d13eae02a63"]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[10423, 268, 153, 3, 67, "Section",ExpressionUUID->"85b92e30-091c-4683-a0e8-6fa1f116316f"],
Cell[CellGroupData[{
Cell[10601, 275, 1755, 43, 19, "Input",ExpressionUUID->"c721ea72-cf81-4e1c-a18c-00b0c7b83469",
 CellOpen->False],
Cell[12359, 320, 2080, 41, 371, "Output",ExpressionUUID->"906c8d38-cd71-4ce1-b336-902d042a95c1"]
}, Open  ]]
}, Open  ]]
}, Open  ]]
}
...
(* NotebookSignature Iw07TB9tGzHv7AwKAD#wFMFQ *)
